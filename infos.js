...
const INFOS = {
  "angers-ico": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `8 en RT ; 2 en MN (1 ICO, 1 CHU)` },
...
RX : principalement au CHU sauf mammo et IRM qui sont fait à l'ICO. Mammo assez dispo (au moins 1/2 journée par semaine), avec TOUT le matériel nécessaire au CQ externe (donc possible de faire quasi tous les tests sans le contrôleur). Scanner et radiologie conventionnelle relativement disponible (au moins 1/2 journée voire + quasiment toutes les semaines). Pour l'interventionnel, arceaux mobiles très dispo en journée, mais c'est un peu + compliqué pour les salles fixes (planning très variable).` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Equipe très sympa et diversité de machines : 8 Phys, 7 Dosi, 4 Tech
...
Moins de CQ aux S3, au profit de la dosimétrie, RC3D VMAT Stéréo, bien aidé par les dosimétristes !` },
      ...
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `andrea.crochet@icloud.com (Imagerie/Radiothérapie, 2024-2026)

adelegabillaud@gmail.com (2023-2025)

theo.letersec@gmail.com (2023-2025)

val.giordano@orange.fr (2022-2024)

mathilde-levardon@hotmail.fr (2021-2023)` }
    ],
    machinesListe: ["Novalis", "Halcyon", "Curiethérapie", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "bordeaux-bergonie": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Disponibilité après 19h30 sauf les jours de CQ mensuel
...
MN gamma caméra disponible a partir de 15h le mardi et TEP à 19h30` },
      { theme: "commentaires-anciennes-promos", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `MN : pas de physicien a plein temps plateau technique réduit (1 gamma et une TEP)

RX : pas de physicien a plein temps` },
    ...
    machinesListe: ["TEP", "Gamma-caméra / SPECT"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "bordeaux-chu": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Disponibilité apres 19h30` },
  ...
  "brest-chru": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `5,5 en RT (dont 0,5 recherche) ; 2 en MN` },
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Grosse activité en Médecine Nucléaire (TEP ~17h30; Scinti 16h30-17h) Radio et TDM dispo; NRI plus compliqué. RTE : 3 TrueBeam, 1 Ethos et 1 scanner Siemens SOMATOM stéréotaxie, vmat` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Service de Médecine Nucleaire flambant neuf, au 3ème étage ! Quasi-100% du stage se déroule à présent à l'ICI (Institut de Cancérologie et d'Imagerie), à l'hôpital de la Cavale Blanche. La ligne 1 du réseau de bus dessert 2 arrêts à l'hôpital depuis le centre-ville. Gros chantier en cours pour l'arrivée du tram à l'hôpital (ligne B) vers 2026. Bureau des DQPRM très proche de ceux des physiciens. Très bonne équipe, ambiance conviviale. 

MN : 
4 Gamma-cameras : 2 Siemens ProSpecta toutes neuves et 2 Siemens Intevo. Fin traitements vers 16h - 16h30. 3 TEP : 2 Siemens Vision et 1 Siemens Vision Quadra (unique en Europe !). Fin traitements vers 17h00. Accès aux machines et au labo chaud très facile, manips sympas et accessibles. Un labo avec activimètre est dédié aux physiciens. 

RX : 
Au même étage, 1 IRM GE et des équipements de radio conventionnelle (très facilement accessible en stage). Dans l'année 2025, installation d'un scanner à comptage photonique. Un 2ème service d'imagerie est présent dans l'hopital (radio conv, scanners, ...) Accès aux blocs pour l'interventionnel lors des contrôles trimestriels ou initiaux. 

Logiciels : 
SyngoVia, MiM, PACS, DACS, QATrack pour les CQ, ...` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Service neuf
...
Le DQ est très vite intégré à la routine CQ machine et CQ patient (ça se calme un peu plus en 2è année), les physiciens et la technicienne sont très dispo dès qu'il y a des questions ou pour l'encadrement.` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `caroffpc@gmail.com (Imagerie, 2024-2026)

paul.gillet.pro@gmail.com (Imagerie, 2023-2025)

delpierre.pauline@gmail.com (Imagerie, 2023-2025)

loreena.quintin@hotmail.fr (Imagerie/Radiothérapie, 2023-2025)

bakondiabaloaffoh@gmail.com (Radiothérapie, 2023-2025)

erwancossker@gmail.com (2022-2024), 

clemence.robert98@gmail.com (2022-2024)

mathieu.pavoine@gmail.com (PM)` }
    ],
    machinesListe: ["TrueBeam", "Novalis", "Ethos", "Curiethérapie", "IntraBeam", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "caen-baclesse": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `imagerie MN : gamma caméra disponible 1h (12h30-13h30) et vers 17h en temps normal // TEP dispo vers 17h ou le matin avant le début des acqui à 9h Radiologie : scanner dispo vers 16h30 // radio conv pas de planning prédéfini IRM : CQ fait durant la pause méridienne des manips` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Le parc machine est identique à celui présenté par les anciennes promos (dont l'ajout d'un scanner dans l'optique de remplacer à terme le BigBore pour l'été 2024). 
Bureaux adjacents avec ceux des encadrants, juste au-dessus des services d'imagerie et de MN, le contact est facile. 
Équipe médicale agréable et avec qui il est facile de discuter (manips, médecins, radiopharmaciens). 

Attention, 1 an de travaux d'aménagement de l'été 2024 à l'été 2025 entre le CHU et Baclesse vont rendre l'accès en voiture compliqué, mais le tram passe à proximité ainsi que quelques lignes de bus.` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `plateau tehcnique : 
2 mmamographes : GE pristina (angio+tomosynhtèse) // GE Esential 
radio conv : 1 mobile stephanix // table stephanix // 1 suspension
3 scanners (imagerie+RT) : philips incisive, siemens confidenceRT, philips big bore (RT mais changement courant 2023)
radio inter : 4 ampli de bloc, 1 salle interventionnelle (philips-allura) 
MN : 3 gamma caméra (siemens intevo bold, siemens symbia T2, GE brivo) // 1 TEP philips vereos 
2 IRM : siemens vida (3T) et siemens aera (1,5T)
...
1 tuteur qui gère la partie radologie-IRM et 1 tuteur qui gère la partie médecine nucléaire ils sont tous les 2 les géniaux. Professionnels, pédagogues et très compétents !` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Plateau technique : 
2 Clinacs, 2 Halcyons, 2 tomo, 1 CyberKnife, Curiethérapie HDR/LDR(I125), IntraBeam + proton 

Participation/réalisation aux CQ (périodiques, patients etc...) 
Autonomie recommandée
Les DQ sont plus ou moins libres de faire ce qu'ils souhaitent (possibilité d'approfondir les fiches sur base de volontariat mais l'inverse est aussi possible + peu d'obligations de participation active au service, mais toujours sur base de volontariat) 
Les physiciens sont plus ou moins disponibles pour répondre aux questions ou pour aller faire des mesures 
Créneau dédié aux CQ périodiques chaque semaine sur une voir deux machines` },
...
thelie.alexis@gmail.com (DQ2)` }
    ...
    machinesListe: ["Clinac", "Halcyon", "Tomothérapie", "CyberKnife", "Protonthérapie", "Curiethérapie", "IntraBeam", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
...
4 accélérateurs Varian (2 Novalis et 2 Clinac) ; 
Participation/réalisation aux CQ Mensuels/semestriels/annuels ; 
Réalisation de perm en binôme avec un physicien ; 
Réalisation de CQ pré-traitement (Delta4/Lucy/PDIP) ; 

R&V sur Aria ; 
Dosimétrie sur Eclipse ;` },
...
auappavou.richard@gmail.com (DQ1)` }
    ...
    machinesListe: ["Novalis", "Clinac", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "dijon-cgfl": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `9 en RT ; 2 en imagerie/MN` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `4` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `RTE : Au mieux après 17/18h, en général 19/20h.
TOP allumage machine matin. DQA midi/soir. Jeudi aprém CQ machine. 
MN : dispo gamma caméra 16h30, labo 16h et TEP après 17h30. 
RX: Scanner/Mammo dispo à partir de 17/18h, salle interventionnelle dédiée: dispo 1 après-midi par semaine (sauf urgences) sinon à partir de 17h.` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Pour les machines : 1 TEP Quadra de Siemens (grand champ), 1 TEP VISION, 2 gamma-caméras miroir Siemens, 1 D-SPECT (dédiée cardiaque). En radiologie : 2 arceaux de blocs (GE, Siemens), salle interventionnelle dédiée Artis zee celling Siemens + scanner interventionnel, 2 mammographes, 1 scanner (Siemens), 1 mobile de radio et 1 salle conventionnelle Nova (Fuji)
Centre situé à 2min à pied de l'arret de tram CHU
Encadrants très présents, toujours disponibles pour répondre aux questions. Très bien encadré en médecine nucléaire avec l'encadrant référent présent pour les contrôles même le soir. Plus d'autonomie à avoir sur les machines en radiologie mais vous ne serez jamais complètement livré à vous même, vous aurez toujours des pistes ou des réponses à vos questions. Si vous êtes qu'un seul DQPRM, il reste aussi avec vous au début pour pas que vous soyez complètement seul. 
Très bonne ambiance dans l'équipe, tout le monde mange ensemble (DQ, physiciens, doctorant, ingénieur de recherche), pas d'horaire tant que le travail est fait, flexibilité pour poser des jours de congé. 
Bureau en MN partagé avec les doctorants / stagiaires de M2 avec une station MIM. Possibilités de suivre les traitements et la clinique. Pas mal de traitement en MN : radioembolisation Yttrium 90, iode 131, xofigo, Lutathera, Lu177-PSMA
Pour les fiches, possibilité de rendre des fiches écrites, diapo, excels... 
Le self est très bon !` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Encadrement : 9 physiciens et 4 dosimétristes
...
- Par contre sur certaine situations on pouvait se sentir parfois mis à l'écart ( Secret Santa, Repas du nouvel an, Pot de départ d'un physicien fait sans nous) et on pouvait sentir la tension/Remarques entre certains membres des équipes. De façon général, il y a quand même plutôt une bonne ambiance` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Une ambiance très conviviale dans l'équipe avec deux physiciens (1 en MN à 100% et l'autre partagé 50/50 entre MN et radio).

Machines:
-MN: 
+ 2 Gamma Caméras GE: NM/CT Discovery 870 & NM/CT Discovery 670 
+ 2 TEP/CT numérique: GE Discovery MI 4 ring & Siemens Biograph 
+ SPECT/CT Cardiaque: DSPECT Spectrum Dynamics

- RX: 
+ 2 Scanners : GE Optima 540 (sera bientôt remplacé par un Siemens) & Siemens SOMATOM Edge (Scanner interventionnel) 
+ 2 Mammographes: Hologic 3Dimension 
+ 2 arceaux de bloc: Siemens CIOS Select FD & arceau GE avec ampli de brillance 
+ Une table télécommandée: Siemens Luminos dRF 
+ Arceau salle dédiée: Siemens Artis Zee ceiling
...
jedidisarahbcr@gmail.com (DQ1, 2021-2024)

sayahfarzam@gmail.com (DQ1, 2021-2024)` }
    ],
    machinesListe: ["TrueBeam", "Novalis", "Halcyon", "IRM-Linac", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "grenoble-chu": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `théoriquement non` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `3 en imagerie` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `~19h/20h selon les machines 
MN : 
-Gamma caméra Siemens Symbia Intevo (*2) - 17h30 
-Gamma caméra Ge Infinia - 15h30 
-TEP - 20h 

Radio : 
-15h30 en conventionelle 
- Scanner après 20h (possibilité d'utiliser le scanner de RT vers 16h, voir avec les phy med de RT)` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Organisation : 3mois en MN puis 3mois en radio avec changement d'encadrement entre les deux. Important de prendre l'initative d'aller voir les examens avec les médecins et les manips. 3 Physicienne (une en MN, une en interventionelle et une 20% MN, 80% conventionelle). Horaires libres et choix de l'ordre des manips à voir avec les physiciens mais assez libre/autonome également.

MN : 
2 Siemens Symbia Intevo, 1 Ge Infina, une caméra CZT scinti myocardique et un TEP Siemens Biograph Horizon
...
Radio : 
Siemens Luminos, Primax Calypso, les scanners vont êtres changés en 2025 (evolution de scanners canons) et potentiel mise à disposition du scanner de RT Siemens SOMATOM Go.sim pour la partie optimisation. Les CQI sont sous-traités, il est intéressant d'aller les voir si ça tombe dans la bonne période.` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `RT:
- 2 Halcyon
- 2 Tomo
- 1 Cyberknife
A l'ete 2026, Halcyon et Tomo fonctionnent en miroir avec une machine de chaque dispo matin et après-midi.
Possible que ce ne soit plus le cas, avec notamment tout les Halcyon fonctionnant le matin avec l'arrivee de nouveau manip à l'automne.` },
...
A savoir : renouvelement complet du service prévu pour 2024 avec construction de nouveaux bunkers (3 à 5)... Physiciens potentiellement très pris par cette activité et la routine` },
    ...
    machinesListe: ["TEP", "Gamma-caméra / SPECT", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "lille-chu": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `MN : 17h (TEP : 17/18h) [5 TEMP, 2 TEP, 1 DSpect], CT : difficile, RX/interv : selon dispo (certaines salles, certains jours), 1 mammographe: selon dispo; IRM : selon dispo [ 2 clinique (1.5 et 3 Tesla) ; 1 recherche]` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Avantages : Très flexible pour poser des congés, horaires libres tant que le travail avance bien et qu'aucune mesure n'est prévue. Equipe sympathique et accessible en cas de questions, pas mal d'autonomie sauf les premières mesures (rassurant lorsqu'on ne connait pas les machines au début).
...
Dans l'ensemble, le stage s'est bien déroulé ! Conseil n'hésitez pas à demander pour aller voir de la clinique :)` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Physicien très acéssible, qui accompagne tout au long du stage, manque d'autonomie qui peut être pesant. L'ambiance est bonne. Ne pas hésiter à sortir du bureau pour se faire connaitre des équipes qui ne sont pas à proximité. 3/4 Physiciens 100% + 1 ingénieur 100%` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `nagy.antho@gmail.com (2023-2026)

reibel.claire@caramail.fr (2023-2026)

marine.deleu@outlook.com (2019-2021)

severine.lannoy@outlook.fr

thelie.alexis@gmail.com (2021-2023)

vincent.beaudoux2@gmail.com (2021-2023)` }
    ],
    machinesListe: ["TEP", "Gamma-caméra / SPECT", "IRM", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
...
vincent.beaudoux2@gmail.com (2021-2023)` }
    ...
    machinesListe: ["TrueBeam", "Clinac", "Halcyon", "Tomothérapie", "Radixact", "CyberKnife", "IRM-Linac", "Curiethérapie", "X-Strahl / Papillon", "IRM"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "lyon-chu": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Radiologie: Les mesures se font dans un service d'urgence, donc les horaires sont (très) variables, à noter qu'une machine est quasiment tout le temps disponible (radio conventionnelle) 
Médecine nucléaire: Les machines sont disponibles à 17h au plus tard, le plus souvent 16h. Un activimètre est à contrôler le matin à 6h30 (mensuellement) 
Radiothérapie: Top le matin par les techniciens/dosimétristes (6h30 pour y assister). Les machines sont disponibles après les traitements pour DQA et fiches de compétences. Pour les CQ mensuels/annuels, la machine est réservée toute la journée (possible d'en profiter pour quelques fiches également` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" }
    ],
    machinesListe: [],
  ...
  "lyon-clb": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `MN : 1 temps plein + 1 à 50 % ; radio : 1 à mi-temps` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Scanner de RT: à partir de 17h, SPECT/CT: à partir de 16h-16h30, TEP: 17h30-18h. EN RT: Un linac ELEKTA dispo à partir de 16h30, Les 5 autres machines à partir de 19h30-20h. Plages CQ machines: 3h par semaine par machine pour CQ réglementaires + Une journée de maintenance par mois par machine. CQ patients (VMAT, TOMO, CyberKnife) plages dédiées en journée ou fin de journée. CQ machine (Aide physiciens/DQPRM). CQ patients (Dosimétristes/DQPRM). TOP réalisé par manips à 7h30.` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Médecine nucléaire : 1 physicien à temps plein (peu disponible), 1 physicien à 50%, autonomie +++, 2 TEP (dont une TEP United Imaging Healthcare unique en Europe ) 3 SPECT 3 Activimètres. Bureaux isolés. Concernant l'encadrement: quelques réunions pour présenter les fiches, mais sinon très peu de suivi et d'apport de la part des physiciens. Bonne ambiance générale au sein du centre et accès facile au travail réalisé par les DQ des années précédentes. 1 jour d'observation réalisé aux HCL (Hospices Civils de Lyon).

Radiologie : 1 physicienne à mi-temps, très organisée et impliquée, met en place un planning pour le déroulement du stage. 

Beaucoup de CQ internes réalisés par des entreprises sous traitantes` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Médecine nucléaire : 1 physicien à temps plein (très impliqué en recherche) 
autonomie +++
2 TEP 3 SPECT 3 Activimètres

Radiologie : 1 physicienne à mi-temps, très organisée 
Beaucoup de CQ internes réalisés par des entreprises sous traitantes` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `AUTONOMIE AUTONOMIE AUTONOMIE. Physiciens disponibles en cas de questions. MN et Radio pas de physiciens à temps plein. Accessibilité à tout sans difficulté particulière. Etre capable de prendre des initiatives pour les manips'+ fiches.` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `daireraymond.nicolas@gmail.com (2024-2026)

nicolas.andre.pro15@gmail.com (2024-2026)

geffroy.maiwenn@gmail.com

hug.rousseau8@gmail.com` }
    ],
    machinesListe: ["Tomothérapie", "CyberKnife", "TEP", "Gamma-caméra / SPECT", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "marseille-ipc": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `8 (4 RT, 2 RT+IM, 2 RT+MN)` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `RT : 4 accélérateurs, 3 elekta et 1 IRM-linac MRIdian. TPS : Raystation et Viewray. Disponibilité des machines pour les DQs sur les jours de CQ et maintenances. TOP et CQ quotidien+hebdo fait par les manips. 8 physiciens dont 4 en RT plein temps, 2 se partagent RT+IM et 2 RT+MN. Les physiciens sont disponibles pour les questions et sympathiques. Beaucoup d'autonomie est attendu sur le long du stage. Les fiches font l'objet d'oraux à présenter devant les physiciens pour validation.` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Les DQPRM sont autonomes et peuvent poser des questions aux physiciens quand ils ont besoin. Toutes les fiches sont à présenter à l'équipe de physiciens, pour s'assurer qu'il n'y a pas d'erreurs dans l'apprentissage. On réalise les fiches mais également plusieurs autres tâches de physiciens, ce qui rend le stage beaucoup plus intéressant. On peut faire des présentations à des congrès si on le souhaite. On n'a pas de jours de congés pour la synthèse mais on a le temps que l'on veut (un mois ou plus) pour réviser à l'institut.` },
...
adam.renard@yahoo.com` }
  ...
  "marseille-timone": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Médecine nucléaire: une gamma caméra utilisée pour les fiches et les CQ dispo souvent à 14h30. TEP vers 16h30. RT: 3 versa dont un inutilisé pour manque de manip donc une machine est dispo tout le temps pour les mesures. DQA faits par dosimétriste le soir, TOP fait par les dosimétristes le matin. Radio: créneau pris par le physicien pour manip des fiches.

Promo 2024-2026 : MN : 2 gammas caméras + 1 CZT + 2 TEP + 6 activimètres. Gammas caméras et TEP disponibles au plus tard à 17h (souvent vers 16h). Temps machine disponible pendant les vacances très important. 
Imagerie : 5 IRM (hors IRM du cemerem), 5 scanners, 1 scanner interventionnel, grande quantité de salles de radiologie et radiologie interventionnelle. 
1 mois d'observation au début du stage` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Très bon encadrement dans les 3 domaines. Très bonne ambiance. A l'arrivée au centre 2 semaines d'observations dans chaque domaine, ce qui est un plus pour les révisions des exams. Renouvellement des machines prévu sur les 5 prochaines années.` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `cloe.roquigny@gmail.com (IM, 2024-2026)

emma.charlot1510@gmail.com (RT, 2024-2026)
...
brahim.mehadji@outlook.fr` }
    ...
    machinesListe: ["Versa", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "montbeliard": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `1 en imagerie ; 4 en RT` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Imagerie : Les machines sont disponibles de façon ponctuelle pour l'imagerie. Pour la médecine nucléaire et le scanner disponibilité après 17h30.` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Attention l'HNFC pour le stage d'imagerie n'est pas à Montbéliard mais à Trévenans (90). 

L'hôpital se situe à Trévenans 15 min à Belfort. C'est préférable de chercher un logement à Belfort plutôt que Montbéliard. 

Il y a une semaine de stage à faire à la Timone, CHU de Marseille, pour réaliser quelques fiches en médecine nucléaire.` },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Equipe très sympathique. Autonomie initiative et communication importante à avoir. 1 physicienne à temps plein pour les modalités d'imagerie à l'HNFC. Equipe de 4 physiciens en RT.` },
...
manyani39@gmail.com` }
  ...
  "montpellier-icm": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `7 en RT ; 1 à 80 % en RX (CHU) ; 1 en MN` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `6` },
      { theme: "service", cle: "equipe.techniciens", titre: "Techniciens", texte: `2 en RT ; 2 en imagerie (CHU)` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `MN : 2 Gamma-caméras GE (1 analogique, 1 numérique) libres à partir de 16h30 et TEP-Scan libre à partir de 17h/17h30. Labo disponible à partir de 14h.
...
Tâches attribuées aux DQ : RIOP (CQ+traitement) avec en moyenne 3 RIOP (max 5) par semaine ; CQ scanner.` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Équipe très sympathique et à l’écoute. Autonomie importante physicienne à temps plein en médecine nucleaire et physicien à temps plein en imagerie.` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `maunet.mathis@gmail.com (2023-2026)

nirmah.omarjee@gmail.com (2023-2026)

elisa.hironde@sfr.fr (IM, 2024-2026)

emma.charlot1510@gmail.com (IM, 2024-2026)

trauchessecdorian@gmail.com (IM, RT)

galliano.geoffrey@gmail.com (IM, RT)` }
    ],
    machinesListe: ["TrueBeam", "Ethos", "IRM-Linac", "Curiethérapie", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe", "EOS"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "mulhouse": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `2 en imagerie` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `MN : à partir de 17h au plus tard (gamma et TEP), labo à partir de 15h
Radio : machines très disponibles dans la journée (salle de pédiatrie peu utilisée, mammo que certains jours dans la semaine, scanner de RT facilement disponible, arceaux et salles facilement dispos pour un créneau de mesure = pas de nocturne à envisager :D)` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `Service : 2 physiciens à plein temps en imagerie, très grand parc : 1 TEP-CT, 1 gamma caméra, 3 activimètres, 10 arceaux, 4 salles fixes interventionnelles, 3 scanners, 10 salles RX conventionnelles, 1 EOS, 5 mobiles, 1 mammo, 3 IRM, utilisation du DACS en routine
...
Possibilité d’obtenir un logement avec le centre hospitalier sur site (loyer réduit), renseignements à voir directement avec les encadrants après le choix de stage` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `ringuenoire.clement@gmail.com (IM, 2023-2025)

thymele.muller-stahn@orange.fr (IM, 2023-2025)` }
    ],
    machinesListe: ["TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe", "EOS"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "nancy-chru": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `plus besoin` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `2 en MN ; 3 en RX (dont temps partiels)` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `La plupart des appareils d'imagerie sont disponibles autour de 16h00 sauf les scanners (compter 17h30 au
...
jacquemin.manon01@gmail.com` }
  ...
  "nantes-ico": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `plus besoin` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `8 en RT ; 2 en MN` },
...
Les mesures se font majoritaiement au Clinac (dispo à partir de 15h30 - 16h) , plus d'accélérateur disponible la journée, équipe très sympa et disponible, autonomie +,` }
  ...
  "nice-cal": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "chomage", titre: "Cotisation chômage", texte: `non` },
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `2-3 en imagerie` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `MN : plusieurs journées bloquées pour les CQ sur SPECT, pour les CQ TEP : le matin jusqu'à 8h ou le soir après 18h (parfois plus tôt). Un activimètre réservé pour les physiciens toujours diponible.
...
N'hésitez pas à profiter des avantages CSE (chèque-vacances, bons de Noël, remboursements de frais de vacances ...etc).` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Formation sur 2 sites (principalement sur le 1er, 1 semaine est prévue sur le 2eme site au S2 pour la fiche CQ, environ 1 mois au S3 pour les fiches photons petits champs et planification en stereotaxie.)
...
Tâches clinique attribuées aux DQ : double calcul d'UM, CQ Patient (1-2/semaine), CQ hebdomadaire (1/1-2semaines) et mensuel (dans notre cas, tous ceux du Clinac), une fois les fiches de planification validées -> planification de traitement sur patients. 
Les tâches de routine clinique se font après habilitation (=évaluation) par un physicien. 
...
Plage de traitement maximale : 8h-19h (dans notre cas nous avons pu avoir régulièrement des moments où les traitements se finissaient vers 16h-17h pour le Clinac). 
La fiche de CQ, les mesures pour les fiches photons, électrons se sont faites sur le Clinac et le Truebeam dans notre cas (probablement uniquement Truebeam pour les prochains étudiants). 
...
En MN : 2 gamma caméras (bientôt 3), un TEP, radiopharmacie, local physique pour préparer les fantômes (préparation de toutes les sources). Un physicien dédié MN plein temps : très bon encadrement/suivi pédagogique, important de participer à la vie du service (service sympa), importance accordée à la rédaction des fiches. Des journées ou demies journées sont bloquées pour la réalisation des CQ.` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `roxane.brunel@hotmail.fr (IM, RT, 2024-2026)

sylviedeoliveiraduarte@gmail.com

jonathan-page@live.com (IM, 2021-2024)
...
matduncanj@gmail.com (DQ1)` }
    ...
    machinesListe: ["TrueBeam", "Clinac", "Halcyon", "Tomothérapie", "CyberKnife", "Protonthérapie", "X-Strahl / Papillon", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "nimes-chu": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "chomage", titre: "Cotisation chômage", texte: `non` },
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `4 en imagerie` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `En permanence : un Clinac 2100D non utilisé en clinique (utilisé seulement par les DQ), sinon les autres linacs sont dispos avant 7h30 et après 19h. En
...
* Infomation RH: pas de cotisation pour le chomage et la retraite sur la fiche de paie (demandé au service concerné)` },
      ...
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `2 physiciens à 100% en imagerie et 2 physiciens à 100% et 50 % en médecine nucléaire. En RT : un planning de fiches est mis en place par les physiciens avec des deadlines. Implication rapide en routine clinique (premiere dosi sur un vrai patient en février). Horaires en RT : 2 jours de garde par semaine (7h30-15h ou 12h-19h30), les 3 autres jours (9h-17h) sont dispos pour révisions + fiches.` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `gracchus.bottin@hotmail.fr

lisachazottes34@gmail.com (2024-2026)

mathildebigot4@gmail.com` }
    ],
    machinesListe: ["Clinac", "Gamma-caméra / SPECT", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "orleans": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `5 en RT ; 2 en MN ; 1 en radio` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `3` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Radiothérapie : 2 Accélerateurs Synergy (Elekta), 1 TrueBeam STX (Varian) et 1 Tomo. TOP faits le matin par les MERMs. Les DQA sont fait par deux équipes, une à 12h pour le Novalis et à 13h pour la tomo. CQ machines faits le mercredi (ou en 2 demi journées) par le technicien. Machines disponibles après les traitements, l'heure dépend de la machine et des jours. En MN gamma caméras.
MN : 3 gamma-caméras dont une CZT, 2 TEP (Vereos et Siemens). Machines disponibles vers 17h.
Radiologie : mesures faites en journée sauf pour le scanner qui est plutôt disponible vers 17h30.` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `MN : 2 physiciens --> tuteur qui accompagne ++. Il apprécie la programmation Python et fait un point théorique sur les fiches avant de les commencer

Radiologie : 1 physicien --> autonomie attendue +++` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `RX : 1 Physicien très bonne ambiance dans le service et physicien disponible ------------
MN : 1 Physicien, très bonne ambiance aussi et disponible également, formation très complète en MN ---------------- Globalement les deux physiciens sont très présents, prise d'initiatives et autonomie appréciées, super ambiance générale dans le service avec tous les membres de l'équipe (Médecins nucléaires, radiopharciens ou manips)` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Avis DQ 2 :
...
Radiothérapie : 5 Physiciens, 3 Dosimétristes (à temps plein). Bon suivi régulier et très bonne ambiance (autonomie et prise d'initiative appréciée). Participation à la routine clinique (CQ patient, CQ machine, dosimétrie et curiethérapie) 
...
Changement à venir : remplacement d'une gamma caméra en MN (été 2020)` },
      { theme: "contacts", cle: "contacts", titre: "", pos: "haut", texte: `clarisse.lecomte23@gmail.com (IM, RT, 2024-2026)
...
coline.gautheron@gmail.com (DQ2, 2018-2020)` }
    ],
    machinesListe: ["TrueBeam", "Novalis", "Synergy", "Tomothérapie", "Curiethérapie", "TEP", "Gamma-caméra / SPECT", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "paris-curie": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `10 en RT ; 2 en imagerie` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `7` },
      { theme: "service", cle: "equipe.techniciens", titre: "Techniciens", texte: `5` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Imagerie :
...
5 Accélérateurs Varian et un Xstrahl pour les traitements cutanés. Curiethérapie gynec + prostate + occulaire (PDR, LDR). ARIA 18 en Novembre 2k25. Top faits par les manips le matin. Accélérateurs disponibles (pour les DQA, les mesures, etc...) le soir après les traitements vers 19h ou en journée lorsqu'il y a moins de manip ou une PMI. MN (SPECT et TEP) disponibles après 17h.` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `2 physiciens en imagerie dont :
...
Validation des fiches se fait en présentations orales réalisées devant les physiciens référents et ceux de l'équipe qui veulent assister.
Equipe RT : 10 physiciens, 5 techniciens, 7 dosimétristes.` },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `MN:1 physicien - planning de fiches établi au début de l'année;
...
charles-bapaume@hotmail.fr (RT, 2023-2025)

nathan.benzazon@hotmail.fr (RT, 2023-2025)
...
hiron.quentin@gmail.com (IM, promo 2019)` }
    ...
    machinesListe: ["TrueBeam", "Clinac", "Halcyon", "Curiethérapie", "X-Strahl / Papillon", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "paris-hegp": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `1 TrueBeam STX avec Exactrac (stéréo)
...
Dispo machine : TTT de 8h à 15h30 puis ensuite disponible pour les CQ ou les mesures du DQ :)` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Accessibilité : Metro 8 terminus Balard, T3a Balard, RER C pont du garigliano
...
Horaire flexible (vous pouvez venir quand vous voulez tant que vous faites votre quota horaire, logique). Bonne équipe légèrement en sous effectif mais bonne ambiance. Savoir être autonome et ne pas hésiter à poser des questions surtout si vous arrivez en S2. Très bonne expérience de mon coté. Beaucoup de routine clinique (dosimétrie, curie, cq). Aucune difficulté recontrée pour poser des congés` },
    ...
    machinesListe: ["TrueBeam", "CyberKnife"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "paris-salpetriere": {
    ...
    sections: [
      ...
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Machines de RT + radiochirurgie :
...
Plages horaires dédiées pour les CQ. Il est demandé aux DQPRM de participer aux TOP (1 à 2/semaine en général), au CQ hebdomadaire des chambres de curiethérapie PDR et de se greffer aux CQ machines (particulièrement durant le S2 comme cette partie fait l'objet d'une fiche).` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Equipe sympathique et bienveillante composée de 11 physiciens et de 2 dosimétristes. 
Le service présente un parc très varié et intéressant pour se former ! 
Les fiches sont bien encadrées, pour chacune d'entre elles, un physicien est désigné responsable.
...
- Accès via M5 ou M6 + parc Vélib dans l'enceinte de la Pitié-Saplêtrière` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `être capable de bosser en autonomie, physiciens en radiothérapie disponibles ++, plateau technique intéressant (1 LINAC, 1 TB STX, 1 Gammaknife, 1 TOMO, CT, IRM LINAC, Curiethérapie HDR/PDR).` },
...
tkayosra@yahoo.fr (promo 2021-2023)` }
    ...
    machinesListe: ["TrueBeam", "Halcyon", "Tomothérapie", "Radixact", "GammaKnife", "IRM-Linac", "Curiethérapie", "IRM"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
...
DQ 24-26 : Pour notre part les horaires sont flexibles, on fait notre propre planning ( si des jours il faut finir plus tôt etc..) 
...
morgane.beucherie@gmail.com (2023-2025)

senemarie89@gmail.com (2023-2025)

estebanjimenezec@gmail.com

severine.lannoy@outlook.fr` }
    ],
    machinesListe: ["Tomothérapie", "Curiethérapie", "TEP", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "rennes-cem": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.autres", titre: "Autres", texte: `3 techniciens biomédicaux` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `RT : 1 Cyberknife, 1 Versa, 2 Halcyon, 1 IRM Linac Elekta Unity, 1 scanner Confidence (Siemens), Curie HDR (projecteur + TPS Elekta) 
TPS RayStation, TPS monaco pour IRM Linac, TPS Precision pour Cyber.
...
En conclusion, le stage à Rennes c'est bien mais ce témoignage est à prendre avec du recul (comme tout témoingnage finalement). Je ne serai en aucun cas être tenu responsable de votre mal être personnel ou/et professionnel à Rennes durant votre semestre d'imagerie. Cordialement. Léo [écrit le 05/05/2026]` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `La RT c'est le point fort du CEM. Le centre est vraiment gâté et peut se vanter de posséder de l'Elekta, du Varian, un CyberKnife dédié à la stéréotaxie intra et extra cranienne ainsi qu'un IRM linac de 1,5 T pour des traitements de radiothérapie adaptative. L'équipe de physique est expérimenté et encadre bien les étudiants. Dès le début du stage de S2, les étudiants DQPRM sont répartis alternativement en une semaine de dosimétrie puis une semaine de CQ. Cet enchainement continue (en gros) jusqu'à la fin du stage. Je tiens à préciser que comme pour le stage d'imagerie, il faut se montrer sérieux et inverti professionellement. 
...
Enfin, de temps en temps, on effectue la maintenance d'un accélérateur avec des membres de l'équipe de physiciens. Même s'il y a beaucoup d'investissement en routine clinique, on a tout le temps de faire les fiches pour l'INSTN. Pour plus d'informations sur le CEM et la vie à Rennes en général, regarder le commentaire du semestre d'imagerie (case à gauche de celle-ci). Je suis très content de faire mon stage de RT au CEM car j'ai le sentiment d'être très bien formé. Je pense qu'il s'agit d'un des meilleurs centres de France pour la formation des étudiants en radiothérapie. C'est pourquoi je le recommande très fortement et sans hésiter le centre Eugène Marquis de Rennes pour vos 2 semestres de RT. Cordialement. Léo [écrit le 05/05/2025]` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `- Important d'être autonome et de s'avoir s'adapter facilement.
...
lemaire.lucien@outlook.fr (DQ1, promo 2022-2025)` }
    ...
    machinesListe: ["Halcyon", "Versa", "CyberKnife", "IRM-Linac", "Curiethérapie", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "rouen-chb": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "chomage", titre: "Cotisation chômage", texte: `non` },
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `8 en RT ; 2 en imagerie/MN` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `7` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `RT : 2 Truebeam Novalis, 1 Halcyon (installation juillet 2021) + 2ème Halcyon (2022)+ 3ème Halcyon Ethos (2025) 
TOP sur portal et chambre tout les matins fait par les techniciens, CQ réalisés tout les matins avec un créneau de 7h à 9h-10h.
Pour les manipulations, très rarement le soir mais créneau à réserver en avance pour le samedi matin` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `-MN: Machines : 2 caméra Anger (symbia) + 1 camera CZT (Dynamicspectrum) et 2 TEP
...
- pas de planning particulier ça revient à l'etudiant de s'organiser selon disponibilité machine et physiciens / 2 physiciens (temps plein) présents à tout moment pour une éventuelle aide / Autonomie ++++++++++++++ / équipe trés trés sympa / bureau partagé avec les physiciens` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `RT :
...
manyani39@gmail.com (RT, promo 2022-2025)` }
    ...
    machinesListe: ["TrueBeam", "Novalis", "Halcyon", "Ethos", "ZapX", "Curiethérapie", "TEP", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "saint-cloud-curie": {
    ...
    sections: [
      ...
      { theme: "service", cle: "equipe.techniciens", titre: "Techniciens", texte: `1 (en formation CQ)` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Im: 1 scanner GE, 1 table radio Primax, 1 mobylett, 3 mammographes/tomosynthèse GE, 1 IRM GE. MN: 1 gamma caméra, 1 TEP Philips Vereos` },
      { theme: "avisRecents", cle: "avisIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: "" },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
    ...
    machinesListe: ["TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "strasbourg-icans": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `8 en RT ; 2 en MN ; 2 en radio (Colmar)` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `6` },
      { theme: "service", cle: "equipe.techniciens", titre: "Techniciens", texte: `2` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
...
Pour la majorité des fiches de radiologie (à l'exception des fiches scanner et de la fiche IRM), vous devrez aller aux hopitaux civils de Colmar, à 30 minutes de train de Strasbourg. L'abonnement de train est remboursé à hauteur de 75% (tout comme celui du tram d'ailleurs, pensez également à demander la tarification solidaire de la CTS si vous avez 26 ans+). Deux physiciennes à temps plein sont sur place pour vous encadrer. Ce stage dans un hôpital plus généraliste permet d'observer de nombreuses indications, ce qui est utile pour sa culture clinique. Vous avez notamment accès à une salle de radiologie interventionnelle dédiée aux tests pour les DQ. Colmar possède également un centre de médecine nucléaire tout neuf comportant 1 TEP/CT Omni Legend de chez GE et 2 gamma caméras NM/CT 870 DR.` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Le service de radiothérapie de l'Institut Strauss (ex-ICANS, juste à côté du CHU de Hautepierre) présente un plateau technique hyper complet et une super ambiance.
...
La formation dispensée par l’Institut Strauss est de haute qualité et nous sommes ravis d’avoir fait notre DQPRM ici !` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `En MN : 4 SPECT dont 2 Symbia (Siemens) et 2 GE / 2 TEP Siemens / 4 activimètres.
...
Soit mesures à réaliser à Colmar pendant 1 mois (frais de déplacement pris en charge) soit sur un autre site Strasbourgeois, discussion avec le centre en cours. Pour plus d’infos sur la partie radio à Colmar, contacté les DQ 22-24` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Equipe se montrant disponible en RT. Il est cependant nécessaire de prendre des initiatives au niveau des fiches et des manips à faire. Physicien à plein temps en MN et dispo en fin d'après-midi si manips à faire.` },
...
c.ringuenoire@icans.eu (IM, promo 2023-2025)` }
    ...
    machinesListe: ["TrueBeam", "Clinac", "Halcyon", "Ethos", "Tomothérapie", "Radixact", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "toulouse-oncopole": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `9 en RT ; 2 en imagerie (Oncopole) + 3 (CHU) + 1 (Carcassonne)` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `6` },
...
- Autonomie ++` },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Autonome sur CQ/astreinte rapidement. Gros centre : 7/8 machines + curithérapie, environ 10 physiciens ETP, 45 manipulateurs, 6 dosimétristes, 2 techniciens. Bon encadrement.` },
...
gwenaelle.sidorski@gmail.com (IM, RT, promo 2023-2026)` }
    ...
    machinesListe: ["TrueBeam", "Novalis", "Halcyon", "Tomothérapie", "Curiethérapie", "Scanner"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
  ...
  "tours-chru": {
    ...
    sections: [
      ...
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Avoir une bonne autonomie. Partie "radiologie" réalisée à Orléans.` }
    ],
    machinesListe: [],
    machines: "",
    avisIm: "",
  ...
  "villejuif-gr": {
    ...
    sections: [
      ...
      { theme: "conditions", cle: "conges", titre: "Congés", texte: `12,5 jours par semestre` },
      { theme: "conditions", cle: "revisions", titre: "Révisions sur place", texte: `oui` },
      { theme: "service", cle: "equipe.physiciens", titre: "Physiciens", texte: `13 en RT ; 1 en RX ; 2 en MN` },
      { theme: "service", cle: "equipe.dosimetristes", titre: "Dosimétristes", texte: `8` },
      { theme: "service", cle: "equipe.autres", titre: "Autres", texte: `5 chargés de CQ` },
      { theme: "machines", cle: "machinesListe", type: "machines", titre: "", pos: "haut", texte: "" },
      { theme: "machines", cle: "machines", titre: "", pos: "haut", just: true, texte: `Disponibilité de l'équipement en Radio :Scanner - après 17h; SPECT - en général dispo en journée; SPECT/CT - après 18h en moyenne; PET - Après 20h;
...
Si vous avez des impératifs, prévenez vos futurs encadrants avant votre arrivée. Il est attendu par l'encadrement que les DQPRM rattrapent leur retard pendant leurs congés/week-end. 

L'encadrement peut-être délicat, communication parfois difficile.` },
      { theme: "avisRecents", cle: "avisRth", titre: "Radiothérapie", pos: "haut", just: true, texte: `Equipe de radiothérapie composée de 13 physiciens, 5 chargés de CQ et 8 dosimétristes. 
2 physiciens responsables de l'organisation générale des DQ avec 1 réunion/mois pour suivre l'avancée des fiches.
Les fiches sont bien organisées et réparties entre tous les physiciens avec des responsables désignés.

L'équipe est sympathique et disponible lors qu'elle est sollicitée, il est nécéssaire que les étudiants soient autonomes, curieux et très actifs dans la routine clinique. 

Il est possibile d'assister aux staff scientifiques du service de RT le vendredi matin : présentations scientifiques des médecins sur pleins de thématiques liées à la radiothérapie et aux présentations (revues bibliographiques oncologiques) des internes le mercredi midi.

Les congés ne peuvent pas être pris en même temps que le co-dq.` },
      { theme: "avisPrecedents", cle: "avisAncIm", titre: "Imagerie (RX / MN)", pos: "haut", just: true, texte: `MN : TEP disponible à partir de 20h sauf un jour par semaine à 18h, spect/ct disponible à partir de 17h et spect seule disponible en journée. Le plateau de MN va changer en 2020 et surement les disponibilites egalement. RX : CT disponibles soirs à partir de 18h, radio et mammo en journée, RI les soirs uniquement. Beaucoup de temps en observation uniquement (sans pouvoir avancer les fiches) au début du semestre. Beaucoup de matériel disponible pour faire les cq. 2 physiciennes à temps plein, un nouveau physicien arrive courant septembre. Une chargée de cq à temps plein également en imagerie. Un peu de routine mais secondaire par rapport à l'observation et aux fiches.` },
      { theme: "avisPrecedents", cle: "avisAncRth", titre: "Radiothérapie", pos: "haut", just: true, texte: "" },
      { theme: "commentaires-anciennes-promos", titre: "", pos: "haut", just: true, texte: `Etre capable de bosser en autonomie.` },
...
orly.saturnin@gmail.com` }
    ...
    machinesListe: ["Novalis", "Versa", "Tomothérapie", "CyberKnife", "ZapX", "Curiethérapie", "X-Strahl / Papillon", "TEP", "Gamma-caméra / SPECT", "IRM", "Scanner", "Mammographe"],
    machines: "",
    avisIm: "",
    avisRth: "",
    avis: "",
